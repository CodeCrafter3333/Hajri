...
import {
  ...
  const SignIn = () => {
  const { loading, isAuthenticated, loginWithPhoneNumber } = useAuth();
  ...
  const handleEmailSignIn = async () => {
    ...
    // This could involve navigating to a new screen for email input,
      ...
      <SafeAreaView className="flex-1 bg-white">
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View className="min-h-screen px-5 items-center justify-center">
            ...
            >
            <Link href={"sign-in"} className="text-white font-[poppinsSemiBold] text-base">
              Sign In with Email
              </Link>
            </TouchableOpacity>
